...
const explanations = {
  ...
  11: "ハッシュ値を比較することで、改ざんの有無を検出できる\n盗聴の防止は暗号化、なりすましの防止は認証が必要",
  12: "ECC（Error-Correcting Code）は誤り訂正符号の一種で、データの信頼性を高めるために使用される技術。",
  13: "120Mバイト*8=960Mビット\n960Mビット ÷ 10Mビット/秒 = 96秒\nnバイト*8=mビット,時間=データ量÷転送速度",
